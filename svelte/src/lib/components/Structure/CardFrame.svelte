<script>
  ...
  <svg version="1.1"
    ...
    <!-- Card Outline takes up the whole space-->
    <rect width="64" height="89" x="00" y="0" fill="#FFEFD3" stroke="#818D92" stroke-width="1" />
    
    <slot></slot>

    <text x="8" y="75" font-size="16" >{xcreaseIcon} {effectivenessIcon} {icon}</text>
